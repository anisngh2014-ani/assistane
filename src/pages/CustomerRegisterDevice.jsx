    ...
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-6">
        ...
        <Step number="2" icon={KeyRound} title="Generate and copy your support code">
          <p className="text-xs text-muted-foreground">Generate one 6-digit support code below. Paste the number into the Agent or share the support link.</p>
        </Step>

        <Step number="3" icon={CheckCircle2} title="Device appears automatically">
          <p className="text-xs text-muted-foreground">Run the Agent, enter the support code, and the device shows up on your dashboard within seconds.</p>
        </Step>
      </div>

      <SupportCodePanel accountId={accountId} />
