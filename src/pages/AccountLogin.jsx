  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        localStorage.setItem("accountDbId", res.data.account_db_id || res.data.account_id);
        localStorage.setItem("accountName", res.data.full_name);
        localStorage.setItem("accountEmail", res.data.email || "");
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="flex justify-center mb-4">
            <img src="/assistane-logo.png" alt="Assistane" className="h-14 w-auto max-w-[240px] object-contain" />
          </div>
