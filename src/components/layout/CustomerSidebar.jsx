...
import { LayoutDashboard, Monitor, Plus, Clock, User, LogOut, X, Download } from "lucide-react";
...
const navItems = [
  ...
  { label: "Download Viewer", path: "/download-viewer", icon: Download },
];
...
export default function CustomerSidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      >
        {/* Brand */}
        <div className="flex items-center justify-between px-6 py-5 border-b border-border shrink-0 h-28 w-full">
          <div className="flex items-center justify-center h-full w-full min-w-0">
            <img src="/assistane-logo.png" alt="Assistane" className="h-14 w-auto max-w-[210px] object-contain" />
          </div>
          <button
            onClick={onClose}
